...
`strict`                    | (Optional) Whether to apply strict checks when running the tests. For example, the input generates a qualification failure if a test issues a warning.
