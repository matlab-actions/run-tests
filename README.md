...
| `code-coverage-metric-level` | <p>(Optional) Location to write the code coverage results in Cobertura XML format,  specified as `statement`, `decision`, `condition`, or `mcdc`. By default, .</p><p>**Example:** `code-coverage-metric-level: statement`</p> |
