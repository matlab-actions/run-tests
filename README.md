...
| `code-coverage-html`         | <p>(Optional) Location to write the code coverage results in HTML format, specified as a folder path relative to the project root folder. The action uses the `code-coverage-metrics` input to determine which coverage metrics to include in the report. If you do not specify `code-coverage-metrics`, the action uses the default value (`auto`).</p><p>**Example:** `code-coverage-html: code-coverage`</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `code-coverage-cobertura`    | <p>(Optional) Location to write the code coverage results in Cobertura XML format, specified as a file path relative to the project root folder. The action uses the `code-coverage-metrics` input to determine which coverage metrics to include in the report. If you do not specify `code-coverage-metrics`, the action uses the default value (`auto`). The Cobertura XML format supports at most line and decision (branch) coverage.</p><p>**Example:** `code-coverage-cobertura: code-coverage/coverage.xml`</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `code-coverage-metrics`      | <p>(Optional) Code coverage metrics to collect, specified as one or more of these values separated by spaces:<ul><li>`statement` — Statement and function coverage</li><li>`decision` (requires MATLAB Test&trade;) — Decision coverage</li><li>`condition` (requires MATLAB Test) — Condition coverage</li><li>`mcdc` (requires MATLAB Test) — Modified condition/decision coverage (MC/DC)</li></ul>These structural coverage metrics (`statement`, `decision`, `condition`, and `mcdc`) are hierarchical—each metric includes all metrics below it. For more information about coverage metrics, see [Types of Code Coverage for MATLAB Source Code](https://www.mathworks.com/help/matlab-test/ug/types-of-code-coverage-for-matlab-source-code.html).</p><p>By default, the value of `code-coverage-metrics` is `auto`. With a MATLAB Test license, `auto` collects all structural coverage metrics: statement, function, decision, condition, and MC/DC. Without a MATLAB Test license, `auto` collects statement and function coverage.</p><p>**Example:** `code-coverage-metrics: decision`</p> |
