classdef CreateCoberturaPluginMetricsSerialExpressionBuilder < scriptgen.expressions.test.CreateCoberturaCodePluginSerialExpressionBuilder ...
    ...
    methods
        function expression = build(obj)
            ...
            if isempty(obj.Metrics)
                ...
                text = sprintf('CodeCoveragePlugin.forFolder({%s}, ''IncludingSubfolders'', true, ''Metrics'', {%s}, ''Producing'', CoberturaFormat(%s))', source, metrics, obj.FilePath);
            end
