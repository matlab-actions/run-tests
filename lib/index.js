...
async function run() {
    ...
    const codeCoverageMetrics = scriptgen.resolveCodeCoverageMetrics(core.getInput("code-coverage-metrics").toLowerCase().trim(), core.getInput("code-coverage-metric-level").toLowerCase().trim());
    const options = {
